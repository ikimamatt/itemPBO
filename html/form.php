...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $item->addItem($nama, $harga, $jumlah, $masuk);
  echo "<script>alert('berhasil menambahkan data');window.location='../html/tabel.php';</script>";
  exit();
}
?>
            ...
            <div class="card-body">
              <form action=" " method="post">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="harga" id="tanggalmasuk">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="date" class="form-control" name="masuk" id="tanggalkeluar">
                </div>
